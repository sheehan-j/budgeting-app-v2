...
import { useYearlySpendingQuery } from "../queries/useYearlySpendingQuery";
import { useCategoriesQuery } from "../queries/useCategoriesQuery";
import Navbar from "../components/navbar/Navbar";
import NotificationBanner from "../components/common/NotificationBanner";
import ButtonSpinner from "../components/common/ButtonSpinner";
import SpendingTableCategoryColumn from "../components/spendingpage/SpendingTableCategoryColumn";

const Spending = () => {
	const { spendingYear, setSpendingYear } = useDataStore((state) => ({
													...
													return (
														<Fragment key={category.name}>
															...
															<div
																...
																key={category.name}
															>
																<div className="py-0.5 px-2 rounded-md text-nowrap">
																	{currentSpend ? currentSpend.toFixed(2) : "-"}
																</div>
															</div>
														</Fragment>
